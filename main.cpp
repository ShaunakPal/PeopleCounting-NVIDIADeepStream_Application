...
#define PGIE_CONFIG_FILE  "ds_pgie_config.yml"
#define SGIE1_CONFIG_FILE "ds_sgie_config.yml"
#define MSCONV_CONFIG_FILE "ds_msgconv_config.yml"
...
//    cudaGetDeviceProperties(&prop, gpu_id);
    ...
    * behaviour of inferencing is set through config file */
    ...
    if (!pgie || !sgie1 || !tracker || !nvdsanalytics || !tiler
    ...
    if (argc > 1 && IS_YAML (argv[1])) {
        ...
        g_printerr("I don't know what to do yet !");
        ...
        g_object_set(G_OBJECT (nvdsanalytics),
                     "config-file", "ds_nvdsanalytics_config.txt",
                     NULL);
    ...
    if (!nvdsanalytics_src_pad)
        ...
        if (msg2p_meta == 0)        //generate payload using eventMsgMeta
            gst_pad_add_probe(nvdsanalytics_src_pad, GST_PAD_PROBE_TYPE_BUFFER,
                              nvdsanalytics_src_pad_buffer_probe, (gpointer) obj_ctx_handle, NULL);
    }
